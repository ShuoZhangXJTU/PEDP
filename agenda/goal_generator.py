...
class GoalGenerator:
    ...
    def __init__(self, data_dir,
        ...
        """
        Args:
            goal_model_path: path to a goal models
            corpus_path: path to a dialog corpus to build a goal models
        """
        ...
        if os.path.exists(self.goal_model_path):
            ...
            logging.info('Loading goal models is done')
        else:
            self._build_goal_model()
            logging.info('Building goal models is done')
